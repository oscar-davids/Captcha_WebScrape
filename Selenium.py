...
currentdir = "C:/Users/TestWin10/PycharmProjects/untitled"



browser = webdriver.Chrome('C:/Users/TestWin10/Documents/webdriver/chromedriver')
...
while i <= 200:
    ...
    browser.get("https://servicesenligne2.ville.montreal.qc.ca/sel/evalweb/index")
    #html = browser.page_source
    #bs = BeautifulSoup(html,'html.parser')
    #imageurl = bs.find_all('', class_='form')


    divelement = browser.find_element_by_css_selector("#type_recherche > div.ui-widget > div > img")

    s = "%03d" % (i)
    full_file_name = 'C:\\Users\\TestWin10\\Documents\\image\\' + s + '.png'
    ...
    recogtext = DllRecognizeTextFromFile(ctypes.c_char_p(full_file_name.encode('utf-8')))

    time.sleep(1)

    inputfield =  browser.find_element_by_css_selector("#type_recherche > div.ui-widget > div > input[type=text]")
